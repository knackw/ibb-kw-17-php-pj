var home =
    {
        ...
        addToCart: function (currBtn) {
            const self = this;
            $(currBtn).html('Warenkorb aktualisieren...').attr('disabled', true);
...
$(document).ready(function () {
        $(".demo_list-rating-info i").mouseenter(function () {
            home.ratingAlternator(this, "hover")
        });
        $(".demo_list-rating-info i").click(function () {
            home.ratingAlternator(this, "click")
        });
        $(".demo_list-rating-info i").mouseleave(function () {
            home.ratingAlternator(this, "exit");
        });
        $(".demo_cart-add-btn").click(function () {
            home.addToCart(this)
        });
