...
$(document).ready(function () {
        $(".demo_cart-update-btn").click(function () {
            cart.update(this)
        });
        $(".demo_cart-remove").click(function () {
            cart.remove(this)
        });
        $(".demo_shipping-type").change(function () {
            cart.updateShippingCost(this)
        });
        $('.demo_list-my-ratings').css('display', 'none');
        $(".demo_checkout-summary").click(function () {
            cart.summary(this)
        });
        $(".demo_checkout-btn").click(function () {
            cart.preCheckout(this)
        });
    }
);